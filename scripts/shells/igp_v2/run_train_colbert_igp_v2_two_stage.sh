...
CUSTOM_OUTPUT_PATH="/home/luwa/Documents/pylate/output/colbert_igp_train/col_two_stage_v2_max0.5"
NOTE="V2两阶段训练-短数据集先训练-再长数据集微调-MAX_RATIO=0.5"
...
echo "============================================================"
echo "🚀 ColBERT-IGP V2 两阶段训练脚本（增加参数量版本）"
echo "============================================================"
echo ""
echo "📊 V2 参数量配置:"
echo "   Probe 层数: ${PROBE_NUM_LAYERS}"
echo "   Adapter Bottleneck: ${BOTTLENECK_DIM}"
echo ""
echo "📊 阶段1: 短数据集训练"
...
# 使用 V2 版本的 Python 脚本
python scripts/training/train_colbert_igp_v2.py \
...
echo ""
echo "============================================================"
echo "🎉 ColBERT-IGP V2 两阶段训练全部完成！"
echo "============================================================"
echo ""
echo "📂 输出目录:"
echo "   阶段1: ${STAGE1_OUTPUT}"
echo "   阶段2: ${STAGE2_OUTPUT}"
echo ""
echo "📊 训练日志:"
echo "   阶段1: ${STAGE1_OUTPUT}/training_stage1.log"
echo "   阶段2: ${STAGE2_OUTPUT}/training_stage2.log"
echo ""
echo "============================================================"
