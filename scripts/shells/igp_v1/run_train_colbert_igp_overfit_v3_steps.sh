...
# ============================================================
# ColBERT-IGP 过拟合训练脚本 (使用 v3 数据集 - Step-based)
# 使用改进的难负样本数据集进行训练
# 按步数训练，每步都记录损失
# ============================================================
...
LOGGING_STEPS=1      # 每1步记录一次损失

# 输出目录 (固定名称，重启后覆盖)
OUTPUT_BASE_DIR="/home/luwa/Documents/pylate/output/colbert_igp_train"
OUTPUT_DIR="${OUTPUT_BASE_DIR}/3.15-onlystage2-overfit-noregloss"

# 备注
NOTE="过拟合训练-v3数据集-step-based-5000steps-改进难负样本-正负比例1:5"
...
PROBE_NUM_LAYERS=3
AUX_LOSS_WEIGHT=0
REG_COEFF=0         # 正则化损失系数，设为0可禁用正则化损失
LOG_INTERVAL=1
...
echo ""
echo "============================================================"
echo "🚀 ColBERT-IGP 过拟合训练 (v3 数据集 - Step-based)"
echo "============================================================"
echo ""
echo "📊 训练配置:"
echo "   数据: ${TRAIN_DATA}"
